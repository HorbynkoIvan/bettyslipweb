          ...
          <v-container fluid grid-list-md class="white lighten-4">
            <v-layout row wrap>
              <v-flex xs12>
                <v-card>
                  <v-card-media
                    src="/static/banners/top_reviews.jpg"
                    height="200px"
                  >
                    <v-container fill-height fluid>
                      <v-layout fill-height row wrap>
                        <v-flex xs12 center flexbox>
                          <div>
                            <div class= "display-1 white--text">Casino Reviews</div>
                            <div class="headline white--text">The Bettys review the best casinos online</div>
                          </div>
                        </v-flex>
              ...
              <v-flex xs12>
                <v-card class="white" flat >
                  <div class="headline black--text">Latest Reviews</div>
                </v-card>
              </v-flex>
              <v-flex xs12>
                <v-card class="white" flat v-for="review in reviews" :key="review.id" >
                  <v-container fluid grid-list-lg>
                    <v-layout row wrap>

                      <v-flex xs12 sm5 md5 lg5>
                        <v-card-media
                          <youtube :video-id=review.videoID
                            @ready="ready"
                            @ended="ended"
                            @playing="paused"
                            @paused="paused"
                      ...
                      <v-flex xs12 sm7 md7 lg7>
                        <div>
                          ...
                          <span class="grey--text">{{ review.category}}</span>
                            <div><span class="grey--text">{{ review.date | date }}</span></div>
                        </div>
                      </v-flex>
                    </v-layout>
                  </v-container>
